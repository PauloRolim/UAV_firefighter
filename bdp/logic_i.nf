...
THEORY ListVisibleVariablesX IS
  ...
  List_VisibleVariables(Implementation(logic_i))==(o_Proceed,i_HighBattery,i_CommsLink,i_MissionStart,valid_pred_6,valid_pred_5,var_patternBit_2,var_patternBit_1,var_P_1,var_read_1,cycle_state,cycle_timer,SM_SimBCMonitor_state,first_time,board_0_O2,board_0_O1);
  Internal_List_VisibleVariables(Implementation(logic_i))==(o_Proceed,i_HighBattery,i_CommsLink,i_MissionStart,valid_pred_6,valid_pred_5,var_patternBit_2,var_patternBit_1,var_P_1,var_read_1,cycle_state,cycle_timer,SM_SimBCMonitor_state,first_time,board_0_O2,board_0_O1)
END
&
THEORY ListInvariantX IS
  ...
  List_Invariant(Implementation(logic_i))==(board_0_O1: uint8_t & board_0_O2: uint8_t & first_time: BOOL & SM_SimBCMonitor_state: uint8_t & SM_SimBCMonitor_state: {INIT,EXEC_1,EXEC_2,EXEC_3} & cycle_timer: uint32_t & cycle_state: uint8_t & cycle_state: {st_READ_INPUTS,st_STATE_MACHINE_CYCLE,st_WRITE_OUTPUTS,st_TIME} & var_read_1: uint32_t & var_P_1: uint32_t & var_patternBit_1: BOOL & var_patternBit_2: BOOL & valid_pred_5: BOOL & valid_pred_6: BOOL & i_MissionStart: uint8_t & i_CommsLink: uint8_t & i_HighBattery: uint8_t & o_Proceed: uint8_t)
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(logic_i))==((IO_OFF: INT | board_0_O1:=IO_OFF);(IO_OFF: INT | board_0_O2:=IO_OFF);first_time:=TRUE;(INIT: INT | SM_SimBCMonitor_state:=INIT);(0: INT | cycle_timer:=0);(1: INT | cycle_state:=1);(0: INT | var_read_1:=0);(0: INT | var_P_1:=0);var_patternBit_1:=TRUE;var_patternBit_2:=FALSE;valid_pred_5:=FALSE;valid_pred_6:=FALSE;(IO_OFF: INT | i_MissionStart:=IO_OFF);(IO_OFF: INT | i_CommsLink:=IO_OFF);(IO_OFF: INT | i_HighBattery:=IO_OFF);(IO_OFF: INT | o_Proceed:=IO_OFF));
  Context_List_Initialisation(Implementation(logic_i))==(skip);
  List_Initialisation(Implementation(logic_i))==(board_0_O1:=IO_OFF;board_0_O2:=IO_OFF;first_time:=TRUE;SM_SimBCMonitor_state:=INIT;cycle_timer:=0;cycle_state:=1;var_read_1:=0;var_P_1:=0;var_patternBit_1:=TRUE;var_patternBit_2:=FALSE;valid_pred_5:=FALSE;valid_pred_6:=FALSE;i_MissionStart:=IO_OFF;i_CommsLink:=IO_OFF;i_HighBattery:=IO_OFF;o_Proceed:=IO_OFF)
END
&
...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Implementation(logic_i),SM_SimBCMonitor)==(cycle_state = st_STATE_MACHINE_CYCLE);
  Own_Precondition(Implementation(logic_i),validBitPattern)==(btrue);
  List_Precondition(Implementation(logic_i),validBitPattern)==(valid: BOOL & pp: BOOL & rr: uint32_t & cc: uint8_t);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(logic_i),validBitPattern)==(valid: BOOL & pp: BOOL & rr: uint32_t & cc: uint8_t | @(valid$1).(valid$1: BOOL ==> valid:=valid$1);(cc = IO_ON ==> (var_patternBit_1:=FALSE;var_patternBit_2:=pp;valid:=TRUE) [] not(cc = IO_ON) ==> (var_patternBit_1:=TRUE;var_patternBit_2:=FALSE;valid:=FALSE)));
  Expanded_List_Substitution(Implementation(logic_i),SM_SimBCMonitor)==(cycle_state = st_STATE_MACHINE_CYCLE | SM_SimBCMonitor_state = INIT ==> (EXEC_1: INT | SM_SimBCMonitor_state:=EXEC_1) [] not(SM_SimBCMonitor_state = INIT) ==> (SM_SimBCMonitor_state = EXEC_1 ==> (i_MissionStart = IO_OFF ==> (EXEC_1: INT | SM_SimBCMonitor_state:=EXEC_1) [] not(i_MissionStart = IO_OFF) ==> skip;(i_MissionStart = IO_ON ==> ((var_P_1: uint32_t | var_P_1:=ms_tick);(EXEC_2: INT | SM_SimBCMonitor_state:=EXEC_2)) [] not(i_MissionStart = IO_ON) ==> skip)) [] not(SM_SimBCMonitor_state = EXEC_1) ==> (SM_SimBCMonitor_state = EXEC_2 ==> ((0: INT | var_read_1:=0);@(guard_1,guard_2,guard_3,guard_4,guard_5,guard_6,guard_7,guard_8,guard_9,guard_10,guard_11,local_since,predicate_1,predicate_2,predicate_3,predicate_4,predicate_5,predicate_6,predicate_7,predicate_8,predicate_9,predicate_10,predicate_11,predicate_12).(@(guard_1$2).(guard_1$2: BOOL ==> guard_1:=guard_1$2);@(guard_2$2).(guard_2$2: BOOL ==> guard_2:=guard_2$2);@(guard_3$2).(guard_3$2: BOOL ==> guard_3:=guard_3$2);@(guard_4$2).(guard_4$2: BOOL ==> guard_4:=guard_4$2);@(guard_5$2).(guard_5$2: BOOL ==> guard_5:=guard_5$2);@(guard_6$2).(guard_6$2: BOOL ==> guard_6:=guard_6$2);@(guard_7$2).(guard_7$2: BOOL ==> guard_7:=guard_7$2);@(guard_8$2).(guard_8$2: BOOL ==> guard_8:=guard_8$2);@(guard_9$2).(guard_9$2: BOOL ==> guard_9:=guard_9$2);@(guard_10$2).(guard_10$2: BOOL ==> guard_10:=guard_10$2);@(guard_11$2).(guard_11$2: BOOL ==> guard_11:=guard_11$2);@(local_since$2).(local_since$2: uint32_t ==> local_since:=local_since$2);@(predicate_1$2).(predicate_1$2: BOOL ==> predicate_1:=predicate_1$2);@(predicate_2$2).(predicate_2$2: BOOL ==> predicate_2:=predicate_2$2);@(predicate_3$2).(predicate_3$2: BOOL ==> predicate_3:=predicate_3$2);@(predicate_4$2).(predicate_4$2: BOOL ==> predicate_4:=predicate_4$2);@(predicate_5$2).(predicate_5$2: BOOL ==> predicate_5:=predicate_5$2);@(predicate_6$2).(predicate_6$2: BOOL ==> predicate_6:=predicate_6$2);@(predicate_7$2).(predicate_7$2: BOOL ==> predicate_7:=predicate_7$2);@(predicate_8$2).(predicate_8$2: BOOL ==> predicate_8:=predicate_8$2);@(predicate_9$2).(predicate_9$2: BOOL ==> predicate_9:=predicate_9$2);@(predicate_10$2).(predicate_10$2: BOOL ==> predicate_10:=predicate_10$2);@(predicate_11$2).(predicate_11$2: BOOL ==> predicate_11:=predicate_11$2);@(predicate_12$2).(predicate_12$2: BOOL ==> predicate_12:=predicate_12$2);predicate_1:=bool(i_CommsLink = IO_ON);predicate_2:=bool(i_HighBattery = IO_ON);(predicate_1: BOOL & predicate_2: BOOL & guard_1: BOOL | @(result$0).(result$0: BOOL ==> guard_1:=result$0));predicate_3:=bool(i_CommsLink = IO_OFF);predicate_4:=bool(i_HighBattery = IO_OFF);(predicate_3: BOOL & predicate_4: BOOL & guard_2: BOOL | @(result$0).(result$0: BOOL ==> guard_2:=result$0));(var_P_1: uint32_t & local_since: uint32_t | @(elapsed$0).(elapsed$0: uint32_t ==> local_since:=elapsed$0));guard_3:=bool(local_since<=TIMEOUT);guard_4:=bool(TIMEOUT<local_since);(predicate_5: BOOL & PATTERN: BOOL & var_read_1: uint32_t & i_CommsLink: uint8_t | @(valid$0).(valid$0: BOOL ==> predicate_5:=valid$0) || @(var_patternBit_1$0).(var_patternBit_1$0: BOOL ==> var_patternBit_1:=var_patternBit_1$0) || @(var_patternBit_2$0).(var_patternBit_2$0: BOOL ==> var_patternBit_2:=var_patternBit_2$0));(predicate_5: BOOL & predicate_6: BOOL | @(result$0).(result$0: BOOL ==> predicate_6:=result$0));(predicate_6: BOOL & predicate_2: BOOL & guard_5: BOOL | @(result$0).(result$0: BOOL ==> guard_5:=result$0));(predicate_5: BOOL & predicate_2: BOOL & guard_6: BOOL | @(result$0).(result$0: BOOL ==> guard_6:=result$0));predicate_7:=bool(i_CommsLink = IO_OFF);predicate_8:=bool(i_CommsLink = IO_OFF);(predicate_7: BOOL & predicate_8: BOOL & predicate_9: BOOL | @(result$0).(result$0: BOOL ==> predicate_9:=result$0));predicate_10:=bool(TIMEOUT<local_since);predicate_11:=bool(i_HighBattery = IO_OFF);(predicate_10: BOOL & predicate_11: BOOL & predicate_12: BOOL | @(result$0).(result$0: BOOL ==> predicate_12:=result$0));(predicate_9: BOOL & predicate_12: BOOL & guard_7: BOOL | @(result$0).(result$0: BOOL ==> guard_7:=result$0));guard_8:=predicate_4;guard_9:=guard_1;(guard_2 = TRUE ==> (guard_3 = TRUE ==> ((IO_ON: INT | o_Proceed:=IO_ON);(EXEC_2: INT | SM_SimBCMonitor_state:=EXEC_2)) [] not(guard_3 = TRUE) ==> (guard_4 = TRUE ==> ((IO_OFF: INT | o_Proceed:=IO_OFF);(EXEC_2: INT | SM_SimBCMonitor_state:=EXEC_2)) [] not(guard_4 = TRUE) ==> skip)) [] not(guard_2 = TRUE) ==> (guard_1 = TRUE ==> (guard_6 = TRUE ==> (guard_3 = TRUE ==> ((IO_ON: INT | o_Proceed:=IO_ON);(EXEC_2: INT | SM_SimBCMonitor_state:=EXEC_2)) [] not(guard_3 = TRUE) ==> (guard_4 = TRUE ==> ((IO_OFF: INT | o_Proceed:=IO_OFF);(EXEC_2: INT | SM_SimBCMonitor_state:=EXEC_2)) [] not(guard_4 = TRUE) ==> skip)) [] not(guard_6 = TRUE) ==> skip) [] not(guard_1 = TRUE) ==> (guard_1 = TRUE ==> (guard_5 = TRUE ==> (guard_7 = TRUE ==> ((IO_OFF: INT | o_Proceed:=IO_OFF);(EXEC_2: INT | SM_SimBCMonitor_state:=EXEC_2)) [] not(guard_7 = TRUE) ==> skip) [] not(guard_5 = TRUE) ==> skip;(guard_8 = TRUE ==> (EXEC_3: INT | SM_SimBCMonitor_state:=EXEC_3) [] not(guard_8 = TRUE) ==> skip)) [] not(guard_1 = TRUE) ==> (guard_1 = TRUE ==> (guard_8 = TRUE ==> (EXEC_3: INT | SM_SimBCMonitor_state:=EXEC_3) [] not(guard_8 = TRUE) ==> skip) [] not(guard_1 = TRUE) ==> skip)))))) [] not(SM_SimBCMonitor_state = EXEC_2) ==> (SM_SimBCMonitor_state = EXEC_3 ==> (IO_OFF: INT | o_Proceed:=IO_OFF) [] not(SM_SimBCMonitor_state = EXEC_3) ==> skip)));(st_WRITE_OUTPUTS: INT | cycle_state:=st_WRITE_OUTPUTS));
  ...
  Expanded_List_Substitution(Implementation(logic_i),read_model_inputs)==(cycle_state = st_READ_INPUTS | (i_MissionStart: uint8_t | i_MissionStart:=board_0_I1);(i_CommsLink: uint8_t | i_CommsLink:=board_0_I2);(i_HighBattery: uint8_t | i_HighBattery:=board_0_I3);(st_STATE_MACHINE_CYCLE: INT | cycle_state:=st_STATE_MACHINE_CYCLE));
  ...
  List_Substitution(Implementation(logic_i),read_model_inputs)==(i_MissionStart <-- get_board_0_I1;i_CommsLink <-- get_board_0_I2;i_HighBattery <-- get_board_0_I3;cycle_state:=st_STATE_MACHINE_CYCLE);
  List_Substitution(Implementation(logic_i),write_model_outputs)==(board_0_O1:=o_Proceed;board_0_O2:=IO_OFF;cycle_state:=st_TIME);
  List_Substitution(Implementation(logic_i),SM_SimBCMonitor)==(IF SM_SimBCMonitor_state = INIT THEN SM_SimBCMonitor_state:=EXEC_1 ELSIF SM_SimBCMonitor_state = EXEC_1 THEN IF i_MissionStart = IO_OFF THEN SM_SimBCMonitor_state:=EXEC_1 END;IF i_MissionStart = IO_ON THEN var_P_1 <-- get_ms_tick;SM_SimBCMonitor_state:=EXEC_2 END ELSIF SM_SimBCMonitor_state = EXEC_2 THEN var_read_1:=0;VAR guard_1,guard_2,guard_3,guard_4,guard_5,guard_6,guard_7,guard_8,guard_9,guard_10,guard_11,local_since,predicate_1,predicate_2,predicate_3,predicate_4,predicate_5,predicate_6,predicate_7,predicate_8,predicate_9,predicate_10,predicate_11,predicate_12 IN guard_1: (guard_1: BOOL);guard_2: (guard_2: BOOL);guard_3: (guard_3: BOOL);guard_4: (guard_4: BOOL);guard_5: (guard_5: BOOL);guard_6: (guard_6: BOOL);guard_7: (guard_7: BOOL);guard_8: (guard_8: BOOL);guard_9: (guard_9: BOOL);guard_10: (guard_10: BOOL);guard_11: (guard_11: BOOL);local_since: (local_since: uint32_t);predicate_1: (predicate_1: BOOL);predicate_2: (predicate_2: BOOL);predicate_3: (predicate_3: BOOL);predicate_4: (predicate_4: BOOL);predicate_5: (predicate_5: BOOL);predicate_6: (predicate_6: BOOL);predicate_7: (predicate_7: BOOL);predicate_8: (predicate_8: BOOL);predicate_9: (predicate_9: BOOL);predicate_10: (predicate_10: BOOL);predicate_11: (predicate_11: BOOL);predicate_12: (predicate_12: BOOL);predicate_1:=bool(i_CommsLink = IO_ON);predicate_2:=bool(i_HighBattery = IO_ON);guard_1 <-- land(predicate_1,predicate_2);predicate_3:=bool(i_CommsLink = IO_OFF);predicate_4:=bool(i_HighBattery = IO_OFF);guard_2 <-- land(predicate_3,predicate_4);local_since <-- since(var_P_1);guard_3:=bool(local_since<=TIMEOUT);guard_4:=bool(TIMEOUT<local_since);predicate_5 <-- validBitPattern(PATTERN,var_read_1,i_CommsLink);predicate_6 <-- lnot(predicate_5);guard_5 <-- land(predicate_6,predicate_2);guard_6 <-- land(predicate_5,predicate_2);predicate_7:=bool(i_CommsLink = IO_OFF);predicate_8:=bool(i_CommsLink = IO_OFF);predicate_9 <-- land(predicate_7,predicate_8);predicate_10:=bool(TIMEOUT<local_since);predicate_11:=bool(i_HighBattery = IO_OFF);predicate_12 <-- land(predicate_10,predicate_11);guard_7 <-- land(predicate_9,predicate_12);guard_8:=predicate_4;guard_9:=guard_1;IF guard_2 = TRUE THEN IF guard_3 = TRUE THEN o_Proceed:=IO_ON;SM_SimBCMonitor_state:=EXEC_2 ELSIF guard_4 = TRUE THEN o_Proceed:=IO_OFF;SM_SimBCMonitor_state:=EXEC_2 END ELSIF guard_1 = TRUE THEN IF guard_6 = TRUE THEN IF guard_3 = TRUE THEN o_Proceed:=IO_ON;SM_SimBCMonitor_state:=EXEC_2 ELSIF guard_4 = TRUE THEN o_Proceed:=IO_OFF;SM_SimBCMonitor_state:=EXEC_2 END END ELSIF guard_1 = TRUE THEN IF guard_5 = TRUE THEN IF guard_7 = TRUE THEN o_Proceed:=IO_OFF;SM_SimBCMonitor_state:=EXEC_2 END END;IF guard_8 = TRUE THEN SM_SimBCMonitor_state:=EXEC_3 END ELSIF guard_1 = TRUE THEN IF guard_8 = TRUE THEN SM_SimBCMonitor_state:=EXEC_3 END END END ELSIF SM_SimBCMonitor_state = EXEC_3 THEN o_Proceed:=IO_OFF ELSE skip END;cycle_state:=st_WRITE_OUTPUTS);
  List_Substitution(Implementation(logic_i),validBitPattern)==(valid: (valid: BOOL);IF cc = IO_ON THEN var_patternBit_1:=FALSE;var_patternBit_2:=pp;valid:=TRUE ELSE var_patternBit_1:=TRUE;var_patternBit_2:=FALSE;valid:=FALSE END);
...
THEORY InheritedEnvX IS
  VisibleVariables(Implementation(logic_i))==(Type(board_0_O1) == Mvv(btype(INTEGER,?,?));Type(board_0_O2) == Mvv(btype(INTEGER,?,?));Type(first_time) == Mvv(btype(BOOL,?,?));Type(SM_SimBCMonitor_state) == Mvv(btype(INTEGER,?,?));Type(cycle_timer) == Mvv(btype(INTEGER,?,?));Type(cycle_state) == Mvv(btype(INTEGER,?,?));Type(var_read_1) == Mvv(btype(INTEGER,?,?));Type(var_P_1) == Mvv(btype(INTEGER,?,?));Type(var_patternBit_1) == Mvv(btype(BOOL,?,?));Type(var_patternBit_2) == Mvv(btype(BOOL,?,?));Type(valid_pred_5) == Mvv(btype(BOOL,?,?));Type(valid_pred_6) == Mvv(btype(BOOL,?,?));Type(i_MissionStart) == Mvv(btype(INTEGER,?,?));Type(i_CommsLink) == Mvv(btype(INTEGER,?,?));Type(i_HighBattery) == Mvv(btype(INTEGER,?,?));Type(o_Proceed) == Mvv(btype(INTEGER,?,?)));
...
THEORY ListVisibleStaticX IS
  List_Constants(Implementation(logic_i),Machine(user_ctx))==(SimBCMonitor_cycle_def,cycle_unit,st_READ_INPUTS,st_STATE_MACHINE_CYCLE,st_WRITE_OUTPUTS,st_TIME,INIT,EXEC_1,EXEC_2,EXEC_3,PATTERN,TIMEOUT);
  List_Constants_Env(Implementation(logic_i),Machine(user_ctx))==(Type(SimBCMonitor_cycle_def) == Cst(btype(INTEGER,?,?));Type(cycle_unit) == Cst(btype(INTEGER,?,?));Type(st_READ_INPUTS) == Cst(btype(INTEGER,?,?));Type(st_STATE_MACHINE_CYCLE) == Cst(btype(INTEGER,?,?));Type(st_WRITE_OUTPUTS) == Cst(btype(INTEGER,?,?));Type(st_TIME) == Cst(btype(INTEGER,?,?));Type(INIT) == Cst(btype(INTEGER,?,?));Type(EXEC_1) == Cst(btype(INTEGER,?,?));Type(EXEC_2) == Cst(btype(INTEGER,?,?));Type(EXEC_3) == Cst(btype(INTEGER,?,?));Type(PATTERN) == Cst(btype(BOOL,?,?));Type(TIMEOUT) == Cst(btype(INTEGER,?,?)));
...
THEORY ListOfIdsX IS
  ...
  List_Of_VisibleVar_Ids(Implementation(logic_i)) == (o_Proceed,i_HighBattery,i_CommsLink,i_MissionStart,valid_pred_6,valid_pred_5,var_patternBit_2,var_patternBit_1,var_P_1,var_read_1,cycle_state,cycle_timer,SM_SimBCMonitor_state,first_time,board_0_O2,board_0_O1 | ?);
...
THEORY VisibleVariablesEnvX IS
  VisibleVariables(Implementation(logic_i)) == (Type(o_Proceed) == Mvv(btype(INTEGER,?,?));Type(i_HighBattery) == Mvv(btype(INTEGER,?,?));Type(i_CommsLink) == Mvv(btype(INTEGER,?,?));Type(i_MissionStart) == Mvv(btype(INTEGER,?,?));Type(valid_pred_6) == Mvv(btype(BOOL,?,?));Type(valid_pred_5) == Mvv(btype(BOOL,?,?));Type(var_patternBit_2) == Mvv(btype(BOOL,?,?));Type(var_patternBit_1) == Mvv(btype(BOOL,?,?));Type(var_P_1) == Mvv(btype(INTEGER,?,?));Type(var_read_1) == Mvv(btype(INTEGER,?,?));Type(cycle_state) == Mvv(btype(INTEGER,?,?));Type(cycle_timer) == Mvv(btype(INTEGER,?,?));Type(SM_SimBCMonitor_state) == Mvv(btype(INTEGER,?,?));Type(first_time) == Mvv(btype(BOOL,?,?));Type(board_0_O2) == Mvv(btype(INTEGER,?,?));Type(board_0_O1) == Mvv(btype(INTEGER,?,?)))
END
&
THEORY VariablesLocEnvX IS
  ...
  Variables_Loc(Implementation(logic_i),SM_SimBCMonitor, 1) == (Type(guard_1) == Lvl(btype(BOOL,?,?));Type(guard_2) == Lvl(btype(BOOL,?,?));Type(guard_3) == Lvl(btype(BOOL,?,?));Type(guard_4) == Lvl(btype(BOOL,?,?));Type(guard_5) == Lvl(btype(BOOL,?,?));Type(guard_6) == Lvl(btype(BOOL,?,?));Type(guard_7) == Lvl(btype(BOOL,?,?));Type(guard_8) == Lvl(btype(BOOL,?,?));Type(guard_9) == Lvl(btype(BOOL,?,?));Type(guard_10) == Lvl(btype(BOOL,?,?));Type(guard_11) == Lvl(btype(BOOL,?,?));Type(local_since) == Lvl(btype(INTEGER,?,?));Type(predicate_1) == Lvl(btype(BOOL,?,?));Type(predicate_2) == Lvl(btype(BOOL,?,?));Type(predicate_3) == Lvl(btype(BOOL,?,?));Type(predicate_4) == Lvl(btype(BOOL,?,?));Type(predicate_5) == Lvl(btype(BOOL,?,?));Type(predicate_6) == Lvl(btype(BOOL,?,?));Type(predicate_7) == Lvl(btype(BOOL,?,?));Type(predicate_8) == Lvl(btype(BOOL,?,?));Type(predicate_9) == Lvl(btype(BOOL,?,?));Type(predicate_10) == Lvl(btype(BOOL,?,?));Type(predicate_11) == Lvl(btype(BOOL,?,?));Type(predicate_12) == Lvl(btype(BOOL,?,?)))
END
&
THEORY TCIntRdX IS
  predB0 == OK;
...
THEORY ListLocalPreconditionX IS
  ...
  List_Local_Precondition(Implementation(logic_i),SM_SimBCMonitor)==(cycle_state = st_STATE_MACHINE_CYCLE);
  List_Local_Precondition(Implementation(logic_i),validBitPattern)==(valid: BOOL & pp: BOOL & rr: uint32_t & cc: uint8_t)
END
&
THEORY ListLocalSubstitutionX IS
  Expanded_List_Local_Substitution(Implementation(logic_i),validBitPattern)==(valid: BOOL & pp: BOOL & rr: uint32_t & cc: uint8_t | @(valid$0).(valid$0: BOOL ==> valid:=valid$0) || @(var_patternBit_1$0).(var_patternBit_1$0: BOOL ==> var_patternBit_1:=var_patternBit_1$0) || @(var_patternBit_2$0).(var_patternBit_2$0: BOOL ==> var_patternBit_2:=var_patternBit_2$0));
  Expanded_List_Local_Substitution(Implementation(logic_i),SM_SimBCMonitor)==(cycle_state = st_STATE_MACHINE_CYCLE | @(cycle_state$0).(cycle_state$0: uint8_t ==> cycle_state:=cycle_state$0) || @(SM_SimBCMonitor_state$0).(SM_SimBCMonitor_state$0: uint32_t ==> SM_SimBCMonitor_state:=SM_SimBCMonitor_state$0) || @(var_patternBit_1$0).(var_patternBit_1$0: BOOL ==> var_patternBit_1:=var_patternBit_1$0) || @(var_patternBit_2$0).(var_patternBit_2$0: BOOL ==> var_patternBit_2:=var_patternBit_2$0) || @(var_P_1$0).(var_P_1$0: uint32_t ==> var_P_1:=var_P_1$0) || @(var_read_1$0).(var_read_1$0: uint32_t ==> var_read_1:=var_read_1$0) || @(o_Proceed$0).(o_Proceed$0: uint8_t ==> o_Proceed:=o_Proceed$0));
  ...
  Expanded_List_Local_Substitution(Implementation(logic_i),execute_model_cycle)==(btrue | @(first_time$0).(first_time$0: BOOL ==> first_time:=first_time$0) || @(SM_SimBCMonitor_state$0).(SM_SimBCMonitor_state$0: uint8_t ==> SM_SimBCMonitor_state:=SM_SimBCMonitor_state$0) || @(cycle_timer$0).(cycle_timer$0: uint32_t ==> cycle_timer:=cycle_timer$0) || @(var_patternBit_1$0).(var_patternBit_1$0: BOOL ==> var_patternBit_1:=var_patternBit_1$0) || @(var_patternBit_2$0).(var_patternBit_2$0: BOOL ==> var_patternBit_2:=var_patternBit_2$0) || @(cycle_state$0).(cycle_state$0: uint8_t ==> cycle_state:=cycle_state$0) || @(var_P_1$0).(var_P_1$0: uint32_t ==> var_P_1:=var_P_1$0) || @(o_Proceed$0).(o_Proceed$0: uint8_t ==> o_Proceed:=o_Proceed$0));
  List_Local_Substitution(Implementation(logic_i),execute_model_cycle)==(first_time:: BOOL || SM_SimBCMonitor_state:: uint8_t || cycle_timer:: uint32_t || var_patternBit_1:: BOOL || var_patternBit_2:: BOOL || cycle_state:: uint8_t || var_P_1:: uint32_t || o_Proceed:: uint8_t);
  ...
  List_Local_Substitution(Implementation(logic_i),read_model_inputs)==(cycle_state:: uint8_t || i_MissionStart:: uint8_t || i_CommsLink:: uint8_t || i_HighBattery:: uint8_t);
  ...
  List_Local_Substitution(Implementation(logic_i),SM_SimBCMonitor)==(cycle_state:: uint8_t || SM_SimBCMonitor_state:: uint32_t || var_patternBit_1:: BOOL || var_patternBit_2:: BOOL || var_P_1:: uint32_t || var_read_1:: uint32_t || o_Proceed:: uint8_t);
  List_Local_Substitution(Implementation(logic_i),validBitPattern)==(valid:: BOOL || var_patternBit_1:: BOOL || var_patternBit_2:: BOOL)
END
&
THEORY TypingPredicateX IS
  TypingPredicate(Implementation(logic_i))==(board_0_O1: INTEGER & board_0_O2: INTEGER & first_time: BOOL & SM_SimBCMonitor_state: INTEGER & cycle_timer: INTEGER & cycle_state: INTEGER & var_read_1: INTEGER & var_P_1: INTEGER & var_patternBit_1: BOOL & var_patternBit_2: BOOL & valid_pred_5: BOOL & valid_pred_6: BOOL & i_MissionStart: INTEGER & i_CommsLink: INTEGER & i_HighBattery: INTEGER & o_Proceed: INTEGER)
END
&
